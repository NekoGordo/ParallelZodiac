    ...
    public override void OnInspectorGUI()
    {
        ...
        if (!EditorGlobals.HideEditors)
        {
            ...
            else
            {
                ...
                self.climbAngle = self.climbAngle = EditorGlobals.ShowOptionSlider("Slide Angle", "Low", "High", 60, self.climbAngle, ref self.MIN_CLIMB_ANGLE, ref self.MAX_CLIMB_ANGLE);
            }
