...
public class BaseSerpentarius {
    ...
    public int Fortitude { get { Stat (); return high; } set { fortitude = value; } }
    ...
    public int Rational { get { Stat (); return high; } set { rational = value; } }

    private int charisma = 0;
    public int Charisma { get { Stat (); return low; } set { charisma = value; } }
